...
import { MapPin, Clock, Lock, Unlock, Phone, Mail, Coins, User as UserIcon, AlignLeft } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="mb-8 flex justify-between items-center">
        ...
        <div className="bg-white p-3 rounded-xl border shadow-sm text-right">
          <p className="text-[10px] text-gray-400 font-bold uppercase">Meus Créditos</p>
          <p className="text-lg font-bold text-amber-600 leading-none">{profile?.credits || 0}</p>
        </div>
      </div>

...
const Home: React.FC<HomeProps> = ({ user }) => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-24 px-4 bg-brand-darkBlue overflow-hidden relative">
         ...
         <div className="max-w-7xl mx-auto bg-brand-orange rounded-[4rem] p-12 md:p-24 text-white flex flex-col md:flex-row items-center gap-16 relative z-10 shadow-3xl">
            <div className="md:w-3/5 space-y-8">
              <h2 className="text-5xl md:text-7xl font-black leading-none tracking-tighter">Ganhe mais <br/>dinheiro com a <span className="text-brand-darkBlue">Samej</span>.</h2>
              <p className="text-xl font-bold opacity-90 leading-relaxed max-w-lg">Receba pedidos de orçamento direto no seu celular e feche novos negócios todos os dias.</p>
      ...
      {/* Testimonials - Estilo Trustpilot */}
